<template>
  <div class="container mt-4">
    ...
    <div class="mx-auto">
      <h3>Search Subject Classes</h3>
      <div class="form-group">
        <input type="text" class="form-control" placeholder="Enter search text" v-model="searchQuery">
      </div>
      <form class="form-inline row">
        <div class="col-md-4 ">
          <label class="my-1 mr-2 w-100">Subject for Area</label>
          <select class="w-100 custom-select my-1" v-model="subjectArea">
            <option selected>Select</option>
            <option value="agriculture">Computer Science</option>
            <option value="health">Civic Education</option>
            <option value="arts">Agriculture</option>
             <option value="arts">Philosophy of Education</option>
          </select>
        </div>
        
        <div class="col-md-4">
          <label class="my-1 mr-2">Search for Length</label>
        ...
        <div class="col-md-4">
          <label class="my-1 mr-2">Search for Type</label>
